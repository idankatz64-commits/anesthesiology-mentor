...
export default function CohortKpiRow({ kpis }: { kpis: CohortKpis }) {
  const cards = [
    { label: "מתמחים פעילים", value: kpis.activeResidents, suffix: "", color: "text-primary", icon: Users },
    { label: "כיסוי מאגר ממוצע", value: kpis.avgCoverage, suffix: "%", color: "text-foreground", icon: BookOpen },
    { label: "דיוק קבוצתי", value: kpis.avgAccuracy, suffix: "%", color: "text-success", icon: Target },
    {
      label: "שאלות/שבוע (ממוצע)",
      value: kpis.avgQuestionsPerWeek,
      suffix: "",
      color: "text-foreground",
      icon: Activity,
    },
    { label: "כדאי לשים לב", value: kpis.attentionCount, suffix: "", color: "text-warning", icon: Eye },
  ];
