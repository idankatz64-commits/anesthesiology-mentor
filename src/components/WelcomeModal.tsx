      ...
      {showWelcome && (
        ...
        >
          ...
          <motion.div
            ...
            className="glass-card w-full max-w-lg rounded-3xl shadow-2xl text-center relative max-h-[90dvh] flex flex-col card-accent-top z-10"
          ...
          >
            <div className="min-h-0 overflow-y-auto overscroll-contain p-6 sm:p-8">
              ...
              <h2 id="welcome-title" className="text-2xl font-bold text-foreground mb-4">ברוכים הבאים לסימולטור הרדמה - איכילוב</h2>
