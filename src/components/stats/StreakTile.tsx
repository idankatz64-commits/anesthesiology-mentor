...
export default function StreakTile({ streak, dailyData }: Props) {
  return (
    <AnimatedStatsTile
      ...
      expanded={
        <div>
          <h3 className="text-lg font-bold text-foreground mb-4">רצף למידה — 30 ימים אחרונים</h3>
              ...
              return (
                <div
                  ...
                  className={`aspect-square rounded-lg flex flex-col items-center justify-center text-[9px] ${
                    active ? 'bg-orange-500/30 text-orange-300' : 'bg-muted/30 text-muted-foreground/40'
                  }`}
