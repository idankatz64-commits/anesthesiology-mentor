...
function ReferenceFormulaManager() {
  ...
  const fetch = useCallback(async () => {
    setLoading(true);
    const { data, error } = await supabase.from("formulas").select("*").order("category").order("formula_name");
    if (error) {
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setEditForm((f) => ({ ...f, formula_name: e.target.value }))}
                />
              </div>
              <div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setEditForm((f) => ({ ...f, equation: e.target.value }))}
                className="font-mono"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => setEditForm((f) => ({ ...f, clinical_note: e.target.value }))}
                rows={2}
              />
            </div>
          </div>
